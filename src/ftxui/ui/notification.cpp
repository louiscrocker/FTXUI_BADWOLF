...
class NotificationManager {
 public:
  ...
  void Add(std::string_view message, Severity severity,
           std::chrono::milliseconds duration) {
...
void Notify(std::string_view message, Severity severity,
            std::chrono::milliseconds duration) {
...
Color SeverityColor(Severity severity) {
  ...
  switch (severity) {
    case Severity::Info:    return t.secondary;
    case Severity::Success: return t.accent;
    case Severity::Warning: return t.warning_color;
    case Severity::Error:   return t.error_color;
    case Severity::Debug:   return t.text_muted;
  }
  return t.secondary;
}
...
Element RenderNotification(const NotificationEntry& entry) {
  ...
  return hbox({
             text(SeverityLabel(entry.severity)) | bold |
                 color(Color::Black) | bgcolor(c),
             text(" " + entry.message + " "),
         }) |
