...
int main() {
                          ...
                          TreeNode::Branch(
                              "component/",
                              {
                                  TreeNode::Leaf(
                                      "app.cpp",
                                      [&] {
                                        on_file("src/ftxui/component/app.cpp");
                                      }),
                                  TreeNode::Leaf(
                                      "button.cpp",
                                      [&] {
                              ...
                              "dom/",
                              {
                                  ...
                                  TreeNode::
                                      Leaf("elements.cpp",
                                           [&] {
                                             on_file(
                                                 "src/ftxui/dom/elements.cpp");
                                           }),
                                  TreeNode::
                                      Leaf("flex.cpp",
                                           [&] {
                                             on_file("src/ftxui/dom/flex.cpp");
                                           }),
                              }),
                          TreeNode::Branch(
                              "ui/",
                              {
                                  TreeNode::Leaf("form.cpp",
                                                 [&] {
                                                   on_file(
                                  ...
                                  TreeNode::
                                      Leaf("theme.cpp",
                                           [&] {
                                             on_file("src/ftxui/ui/theme.cpp");
                                           }),
                                  TreeNode::
                                      Leaf("wizard.cpp",
                                           [&] {
                                             on_file("src/ftxui/ui/wizard.cpp");
                                           }),
                              }),
                      }),
              }))
              ...
              "examples/",
              {
                  TreeNode::Branch(
                      "ui/",
                      {
                          TreeNode::Leaf(
                              "form_demo.cpp",
                              [&] { on_file("examples/ui/form_demo.cpp"); }),
                          TreeNode::Leaf(
                              "mvu_counter.cpp",
                              [&] { on_file("examples/ui/mvu_counter.cpp"); }),
                          TreeNode::Leaf(
                              "tree_demo.cpp",
                              [&] { on_file("examples/ui/tree_demo.cpp"); }),
                      }),
              }))
          .Node(TreeNode::Leaf("CMakeLists.txt",
                               [&] { on_file("CMakeLists.txt"); }))
  ...
  auto detail = Renderer([&]() -> Element {
    ...
    return hbox({
        text("  "),
        text(selected_path) | bold | color(t.accent),
    });
  });
